...
import VendDeliveryDateModal from "./vendDeliveryDateModal";
import VendVisaCardPaymentModal from "./vendVisaCardPaymentModal";

const VendCheckoutModal = ({ onClose }) => {
...
export default VendCheckoutModal;

...
const VendDeliveryDateModal = ({ onClose, onConfirm }) => {
  ...
  return (
    <div>
      ...
      {showPaymentModal && <VendVisaCardPaymentModal onClose={() => setShowPaymentModal(false)} />}
    </div>
  );
};

export default VendDeliveryDateModal;
